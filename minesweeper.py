...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Get nearby cells, discarding safes and moves which are already made.
        ...
        #To mark additional cells as safe and mines after concluding grom AI's Knowege further.
        new_safes = set()
        new_mines = set()
